...
% Pure 150Hz tones with post-stimulus hyperpolarising currents
...
switch stimNum
    ...
    case 2 % with smaller post-stimulus current injection
        ...
        currentCommand(pulseStartInd:pulseEndInd) = -0.0394/4;
    ...
    case 6 % without a stimulus with larger current injection 
        stim = noStimulus;
        stim.waveDur = 14;
        % Make current command
        currentCommand = zeros(size(stim.stimulus));
